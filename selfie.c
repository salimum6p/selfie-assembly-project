  ...
  if(symbol == SYM_REG){
    ...
    if(symbol == SYM_COMMA){
      ...
      if(symbol == SYM_ADDR){
        ...
        arg2 = hex2int(string);
        emit_lui(arg1,sign_extend(arg2, 20));
    ...
    if(symbol == SYM_COMMA){
      ...
      if(symbol == SYM_IMM){
        ...
        if(symbol == SYM_LPARENTHESIS){
          get_assembly_symbol();
          if(symbol == SYM_REG){
            arg3 = get_register_type();
            get_assembly_symbol();
            if(symbol == SYM_RPARENTHESIS){
              if(INST_SUB_TYPE == LD){
                emit_ld(arg1,arg3,arg2);


              }else if(INST_SUB_TYPE == SD){
                emit_sd(arg3,arg2,arg1);
        ...
        if(symbol == SYM_COMMA){
          ...
          if(symbol == SYM_REG){
            ...
            if(INST_SUB_TYPE == ADD){
              emit_add(arg1,arg2,arg3);

            }else if(INST_SUB_TYPE == SUB){
              emit_sub(arg1,arg2,arg3);

            }else if(INST_SUB_TYPE == MUL){
              emit_mul(arg1,arg2,arg3);
            }else if(INST_SUB_TYPE == DIVU){
              emit_divu(arg1,arg2,arg3);
            }else if(INST_SUB_TYPE == REMU){
              emit_remu(arg1,arg2,arg3);
            }else if(INST_SUB_TYPE == SLTU){
              emit_sltu(arg1,arg2,arg3);
